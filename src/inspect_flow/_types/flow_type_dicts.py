...
#   filename:  <stdin>
#   timestamp: 2025-10-22T14:49:42+00:00
...
class JSONSchemaDict(TypedDict):
    ...
    additionalProperties: NotRequired[Optional[Union[Union["JSONSchema", JSONSchemaDict], bool]]]
...
class GenerateConfigDict(TypedDict):
    ...
    batch: NotRequired[Optional[Union[bool, int, Union["BatchConfig", BatchConfigDict]]]]
...
class TaskConfigDict(TypedDict):
    ...
    args: NotRequired[Optional[List[Dict[str, Any]]]]
    solvers: NotRequired[
        Optional[List[Union[Union["SolverConfig", SolverConfigDict], List[Union["SolverConfig", SolverConfigDict]], Union["AgentConfig", AgentConfigDict]]]]
    ]
    models: NotRequired[Optional[List[Union["ModelConfig", ModelConfigDict]]]]
    config: NotRequired[Optional[Union["GenerateConfig", GenerateConfigDict]]]
    model_roles: NotRequired[Optional[List[Dict[str, Union[Union["ModelConfig", ModelConfigDict], str]]]]]
    sandbox: NotRequired[Optional[Union[str, List, Union["SandboxEnvironmentSpec", SandboxEnvironmentSpecDict]]]]
    approval: NotRequired[Optional[Union[str, Union["ApprovalPolicyConfig", ApprovalPolicyConfigDict]]]]
...
class MatrixDict(TypedDict):
    tasks: List[Union["TaskConfig", TaskConfigDict]]
    args: NotRequired[Optional[List[Dict[str, Any]]]]
    models: NotRequired[Optional[List[Union["ModelConfig", ModelConfigDict]]]]
    model_roles: NotRequired[Optional[List[Dict[str, Union[Union["ModelConfig", ModelConfigDict], str]]]]]
    solvers: NotRequired[
...
class FlowConfigDict(TypedDict):
    ...
    eval_set_options: NotRequired[Optional[Union["EvalSetOptions", EvalSetOptionsDict]]]
