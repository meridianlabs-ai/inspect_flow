...
class TaskConfigDict(TypedDict):
    ...
    solvers: NotRequired[
        Optional[
            List[
                Union[
                    Union["SolverConfig", "SolverConfigDict"],
                    List[Union["SolverConfig", "SolverConfigDict"]],
    ...
    model_roles: NotRequired[
        Optional[List[Dict[str, Union[Union["ModelConfig", "ModelConfigDict"], str]]]]
    ]
    sandbox: NotRequired[
        Optional[
            Union[
...
class FlowConfigKwargs(FlowConfigDict, total=False):
    """All fields optional for keyword argument initialization."""
