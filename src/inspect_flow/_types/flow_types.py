...
class TaskConfigDict(TypedDict):
        ...
        Optional[
            Sequence[
                Union[
                    ...
                    Sequence[Union[str, "SolverConfig", "SolverConfigDict"]],
    ...
    models: NotRequired[
        Optional[Sequence[Union[str, "ModelConfig", "ModelConfigDict"]]]
    ]
    config: NotRequired[Optional[Union["GenerateConfig", "GenerateConfigDict"]]]
    model_roles: NotRequired[
        Optional[
            Sequence[
                Mapping[str, Union[Union[str, "ModelConfig", "ModelConfigDict"], str]]
            ]
        ]
    ]
    sandbox: NotRequired[
...
class MatrixDict(TypedDict):
    tasks: Sequence[Union[str, "TaskConfig", "TaskConfigDict"]]
    args: NotRequired[Optional[Sequence[Mapping[str, Any]]]]
    models: NotRequired[
        Optional[Sequence[Union[str, "ModelConfig", "ModelConfigDict"]]]
    ]
...
class FlowConfigDict(TypedDict):
    ...
    matrix: Sequence[Union["Matrix", "MatrixDict"]]
