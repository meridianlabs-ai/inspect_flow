...
`factory` [FlowFactory](../reference/inspect_flow.html.md#flowfactory)\[Agent\] \| Callable\[..., Agent\] \| str \| None \| NotGiven  
...
`agent_prefix` dict\[str, [FlowAgent](../reference/inspect_flow.html.md#flowagent)\] \| None \| NotGiven  
Agent defaults for agent name prefixes. E.g. `{'inspect/': FAgent(...)}`

`model` [FlowModel](../reference/inspect_flow.html.md#flowmodel) \| None \| NotGiven  
Field defaults for models.

`model_prefix` dict\[str, [FlowModel](../reference/inspect_flow.html.md#flowmodel)\] \| None \| NotGiven  
Model defaults for model name prefixes. E.g. `{'openai/': FModel(...)}`

`solver` [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| None \| NotGiven  
Field defaults for solvers.

`solver_prefix` dict\[str, [FlowSolver](../reference/inspect_flow.html.md#flowsolver)\] \| None \| NotGiven  
Solver defaults for solver name prefixes. E.g. `{'inspect/': FSolver(...)}`

`task` [FlowTask](../reference/inspect_flow.html.md#flowtask) \| None \| NotGiven  
Field defaults for tasks.

`task_prefix` dict\[str, [FlowTask](../reference/inspect_flow.html.md#flowtask)\] \| None \| NotGiven  
...
Wraps a factory callable or string reference with its arguments. When a callable is provided, arguments are bound at construction time so that type errors are caught immediately rather than at evaluation time. When a string is provided, it is treated as a registry name (equivalent to passing a string directly to the `factory` field of the parent Flow type).

Works with [FlowTask](../reference/inspect_flow.html.md#flowtask), [FlowAgent](../reference/inspect_flow.html.md#flowagent), [FlowSolver](../reference/inspect_flow.html.md#flowsolver), [FlowScorer](../reference/inspect_flow.html.md#flowscorer), and [FlowModel](../reference/inspect_flow.html.md#flowmodel).
...
`factory` [FlowFactory](../reference/inspect_flow.html.md#flowfactory)\[Model\] \| Callable\[..., Model\] \| str \| None \| NotGiven  
...
`display` [DisplayType](../reference/inspect_flow.api.html.md#displaytype) \| None \| NotGiven  
...
`factory` [FlowFactory](../reference/inspect_flow.html.md#flowfactory)\[Scorer\] \| Callable\[..., Scorer\] \| str \| None \| NotGiven  
...
`factory` [FlowFactory](../reference/inspect_flow.html.md#flowfactory)\[Solver\] \| Callable\[..., Solver\] \| str \| None \| NotGiven  
...
`includes` Sequence\[str \| [FlowSpec](../reference/inspect_flow.html.md#flowspec)\] \| None \| NotGiven  
...
`store` Literal\['auto'\] \| str \| [FlowStoreConfig](../reference/inspect_flow.html.md#flowstoreconfig) \| None \| NotGiven  
Path to directory to use for flow storage, or a [FlowStoreConfig](../reference/inspect_flow.html.md#flowstoreconfig) with path and filter options. `'auto'` will use a default application location. `None` will disable storage. Relative paths will be resolved relative to the config file (when using the CLI) or `base_dir` arg (when using the API). If not given, `'auto'` will be used.
...
If `True`, create a unique log directory by appending a datetime subdirectory (e.g. `2025-12-09T17-36-43`) under the specified `log_dir`. If `False`, use the existing `log_dir` (which must be empty or have `log_dir_allow_dirty=True`). Defaults to `False`.
...
`dependencies` [FlowDependencies](../reference/inspect_flow.html.md#flowdependencies) \| None \| NotGiven  
...
`options` [FlowOptions](../reference/inspect_flow.html.md#flowoptions) \| None \| NotGiven  
Arguments for calls to `eval_set()`.

`env` dict\[str, str\] \| None \| NotGiven  
Environment variables to set when running tasks.

`defaults` [FlowDefaults](../reference/inspect_flow.html.md#flowdefaults) \| None \| NotGiven  
Defaults values for Inspect objects.

`flow_metadata` dict\[str, Any\] \| None \| NotGiven  
Optional. Metadata stored in the flow config. Not passed to the model.

`tasks` Sequence\[str \| [FlowTask](../reference/inspect_flow.html.md#flowtask) \| Task\] \| None \| NotGiven  
Tasks to run

`instantiate` InstantiateMode \| [InstantiateConfig](../reference/inspect_flow.html.md#instantiateconfig) \| None \| NotGiven  
How to instantiate tasks before running. `'serial'` (default) instantiates one task at a time. `'by_task'` parallelizes across distinct task names but serializes instances that share a name. `'parallel'` instantiates everything concurrently. Pass an [InstantiateConfig](../reference/inspect_flow.html.md#instantiateconfig) to also set `max_threads`.

`internal` FlowInternal \| None \| NotGiven  
Internal state populated by the spec loader. Not intended for direct user configuration.
...
Path to directory to use for flow storage. `'auto'` will use a default application location. `None` will disable storage.

`filter` SkipValidation\[[LogFilter](../reference/inspect_flow.html.md#logfilter)\] \| str \| Sequence\[SkipValidation\[[LogFilter](../reference/inspect_flow.html.md#logfilter)\] \| str\] \| None  
Log filter to apply when searching for existing logs. Can be a callable, a registered filter name, a sequence of filters (all must pass), or `None`.
...
`factory` [FlowFactory](../reference/inspect_flow.html.md#flowfactory)\[Task\] \| Callable\[..., Task\] \| str \| None \| NotGiven  
...
Extra args to provide to creation of inspect objects for this task. Will override args provided in the `args` field on the [FlowModel](../reference/inspect_flow.html.md#flowmodel), [FlowSolver](../reference/inspect_flow.html.md#flowsolver), [FlowScorer](../reference/inspect_flow.html.md#flowscorer), and [FlowAgent](../reference/inspect_flow.html.md#flowagent).

`solver` str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| [FlowAgent](../reference/inspect_flow.html.md#flowagent) \| Solver \| Agent \| Sequence\[str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| Solver\] \| None \| NotGiven  
Solver or list of solvers. Defaults to `generate()`, a normal call to the model.

`scorer` str \| [FlowScorer](../reference/inspect_flow.html.md#flowscorer) \| Scorer \| Sequence\[str \| [FlowScorer](../reference/inspect_flow.html.md#flowscorer) \| Scorer\] \| None \| NotGiven  
Scorer or list of scorers used to evaluate model output.

`model` str \| [FlowModel](../reference/inspect_flow.html.md#flowmodel) \| Model \| None \| NotGiven  
...
`epochs` int \| [FlowEpochs](../reference/inspect_flow.html.md#flowepochs) \| None \| NotGiven  
...
`'serial'` instantiates one task at a time. `'by_task'` parallelizes across distinct task names but serializes instances that share a name. `'parallel'` instantiates everything concurrently.

`max_threads` int  
Maximum worker threads to use for instantiation.
...
The decorated function receives the list of instantiated `Task` objects and may either return a new list (replacing the tasks that `eval_set` sees) or return `None` to keep the list it was given (after any in-place edits).
...
`func` StepFunction\[P\]  
A function that takes a list of EvalLog objects and performs operations on them (tag, validate, copy, etc.).
...
`agent` str \| [FlowAgent](../reference/inspect_flow.html.md#flowagent) \| Sequence\[str \| [FlowAgent](../reference/inspect_flow.html.md#flowagent)\]  
...
def agents_with(
    *,
    ...
    factory: FlowFactoryAgent | str | NotGiven | None = ...,
...
`add` \_T  
The object to merge into the base. Only explicitly set fields override those in `base`.
...
`model` str \| [FlowModel](../reference/inspect_flow.html.md#flowmodel) \| Sequence\[str \| [FlowModel](../reference/inspect_flow.html.md#flowmodel)\]  
...
def models_with(
    *,
    model: str | FlowModel | Sequence[str | FlowModel],
    name: str | NotGiven | None = ...,
    factory: FlowFactoryModel | str | NotGiven | None = ...,
...
`solver` str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| Sequence\[str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver)\]  
...
def solvers_with(
    *,
    solver: str | FlowSolver | Sequence[str | FlowSolver],
    name: str | NotGiven | None = ...,
    factory: FlowFactorySolver | str | NotGiven | None = ...,
    args: Mapping[str, Any] | NotGiven | None = ...,
    flow_metadata: Mapping[str, Any] | NotGiven | None = ...,
) -> list[FlowSolver]
```
...
`task` str \| [FlowTask](../reference/inspect_flow.html.md#flowtask) \| Sequence\[str \| [FlowTask](../reference/inspect_flow.html.md#flowtask)\]  
The task or list of tasks to matrix.

`args` Sequence\[Mapping\[str, Any\] \| NotGiven \| None\] \| None  
Additional args to pass to task constructor

`solver` Sequence\[str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| [FlowAgent](../reference/inspect_flow.html.md#flowagent) \| Solver \| Agent \| Sequence\[str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| Solver\] \| NotGiven \| None\] \| None  
Solver or list of solvers. Defaults to `generate()`, a normal call to the model.

`model` Sequence\[str \| [FlowModel](../reference/inspect_flow.html.md#flowmodel) \| Model \| NotGiven \| None\] \| None  
Default model for task (Optional, defaults to eval model).
...
def tasks_with(
    *,
    task: str | FlowTask | Sequence[str | FlowTask],
    name: str | NotGiven | None = ...,
    factory: FlowFactoryTask | str | NotGiven | None = ...,
    args: Mapping[str, Any] | NotGiven | None = ...,
...
`solver` str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| [FlowAgent](../reference/inspect_flow.html.md#flowagent) \| Solver \| Agent \| Sequence\[str \| [FlowSolver](../reference/inspect_flow.html.md#flowsolver) \| Solver\] \| NotGiven \| None  
Solver or list of solvers. Defaults to `generate()`, a normal call to the model.

`scorer` str \| [FlowScorer](../reference/inspect_flow.html.md#flowscorer) \| Scorer \| Sequence\[str \| [FlowScorer](../reference/inspect_flow.html.md#flowscorer) \| Scorer\] \| NotGiven \| None  
Scorer or list of scorers used to evaluate model output.

`model` str \| [FlowModel](../reference/inspect_flow.html.md#flowmodel) \| Model \| NotGiven \| None  
Default model for task (Optional, defaults to eval model).
...
`epochs` int \| [FlowEpochs](../reference/inspect_flow.html.md#flowepochs) \| NotGiven \| None  
Epochs to repeat samples for and optional score reducer function(s) used to combine sample scores (defaults to `"mean"`)
