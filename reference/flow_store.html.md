...
| [list](#flow-store-list) | List logs and log directories in the store. With –json, the display-only –format option is ignored. |
...
List logs and log directories in the store. With –json, the display-only –format option is ignored.
