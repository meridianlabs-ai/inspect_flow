---
title: "Flow Store"
llms-description: Persistent log store for reuse across runs.
tbl-colwidths: [30,70]
---
...
::: callout-note
Filters are also used by [`flow step`](steps.qmd) to select which logs to process.
:::
...
- Task limits (message_limit, token_limit, turn_limit, time_limit, working_limit, cost_limit)
