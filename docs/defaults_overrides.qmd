...
::: callout-note
### None Values Don't Override (Except FlowTask)

With the exception of FlowTask, setting a field to `None` means "not specified" — it won't override existing values from defaults. This allows partial configs to merge cleanly:
